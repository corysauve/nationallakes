...
Explore U.S. EPA National Lakes Assessment (NLA) data in an R friendly format.   

## Basic Usage 

nationallakes contains survey data organized by *Indicator* and `survey_year`. NLA survey years are 2007, 2012, and 2017. However, not all indicators were collected in every survey and only partial results are currently available for 2017.
...
All available indicator data is loaded when nationallakes is called To access a particular dataset, simply type it's name: 
```{r}
